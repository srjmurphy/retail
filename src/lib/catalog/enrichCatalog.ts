...
const specificEnrichment: Record<string, Enrichment> = {
  ...
  "35788": {
    occasionTags: ["work gala", "holiday party", "winter wedding", "style inspiration"],
    styleTags: ["black heels", "occasion footwear", "evening", "complete the look"],
    price: 92,
  ...
  "33981": {
    occasionTags: ["work gala", "holiday party", "winter wedding", "style inspiration"],
    styleTags: ["black stockings", "accessory", "evening", "complete the look"],
    price: 28,
    available_sizes: ["S", "M", "L", "One Size"],
    inventory_health_score: 87,
    commercial_priority_score: 83,
    storeAvailability: "Oak Street flagship",
  },
  "32379": {
